...
elseif( $_REQUEST['captcha'] == $_SESSION['captcha'] ):
    ...
    <p>
        Die folgenden Daten wurden übermittelt und gespeichert. Kehre jetzt <a href="neueErfahrung.php?firma=<?php echo urlencode($_REQUEST['name']) ?>" target="_blank">zurück</a> und trage deine Daten ein.
    </p>
